                        ...
                        children: <Widget>[
                          Text('topLength',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot.data()['topLength'],
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('shoulders',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot.data()['shoulders'],
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('chest',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot.data()['chest'],
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('waist',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot.data()['waist'],
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('hips',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot.data()['hips'].toString(),
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
